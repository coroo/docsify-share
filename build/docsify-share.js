...
exports.install = function (hook, vm) {
    ...
    var facebook = vm.config.share.facebook != undefined ? '<a href="https://www.facebook.com/sharer.php?u=' + ((_a = vm.config.share.whatsapp.url) !== null && _a !== void 0 ? _a : window.location.href) + '" target="_blank" class="fab indigo" tooltip="Facebook"><i class="fa fa-facebook animated"></i></a>' : '';
    ...
    var telegram = vm.config.share.telegram != undefined ? '<a href="https://telegram.me/share/url?url=&' + ((_j = vm.config.share.telegram.url) !== null && _j !== void 0 ? _j : window.location.href) + 'text=' + ((_k = vm.config.share.telegram.title) !== null && _k !== void 0 ? _k : document.title) + '" data-action="share/whatsapp/share" target="_blank" class="fab black" tooltip="Telegram"><i class="fa fa-telegram animated"></i></a>' : '';
    var footer = [
